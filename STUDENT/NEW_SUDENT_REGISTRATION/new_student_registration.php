                ...
                <div class="card h-100 shadow border-0" style="border-radius: 12px;">
                    <div class="card-body" style="padding: 35px;">
                        ...
                        <p style="font-size: 15px; line-height: 1.6; color: #212529; margin-bottom: 20px;">
                            ...
                            before proceeding with your application configuration mapping parameters.
                        </p>
                        ...
                        <div
                            style="background-color: #F8F9FA; padding: 18px 20px; border-radius: 8px; border-left: 5px solid #0D6EFD; margin-top: 30px; box-shadow: inset 0 1px 3px rgba(0,0,0,0.02);">
                            <p style="margin: 0; font-size: 13.5px; line-height: 1.5; color: #495057;">
                                ...
                                Any falsification of documents or system entry data data will result in the automatic
