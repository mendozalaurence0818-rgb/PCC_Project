...
try {
    ...
    if ($system_config && $system_config['enrollment_status'] === 'Closed') {
        ?>
        <!DOCTYPE html>
        <html lang="en">
...
<body>
            ...
            <div class="col-lg-5 d-flex flex-column justify-content-between">
                ...
                <div class="card shadow border-0 mb-4" style="border-radius: 12px;">
                    <div class="card-body" style="padding: 30px;">
                        ...
                        <form id="frmAdmissionApplication" action="NEW_STUDENT_ADMISSION/new_student_profile.php" method="GET">
                            <div class="mb-3">
                                <label
                                    style="font-size: 14px; font-weight: 700; color: #495057; margin-bottom: 6px; display: block;">
                                    Applicant Classification
                                </label>
                                <select id="selClassification" name="classification" class="form-select form-select-lg"
                    ...
                    <div class="card-body" style="padding: 35px;">
                        ...
                        <div
                            ...
                            <p style="margin: 0; font-size: 13.5px; line-height: 1.5; color: #43484d;">
                                ...
                                is accurate and true. Any falsification of documents or system entry data will result in the automatic
                                invalidation of your application records.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function executeAdmissionSubmit() {
            ...
            // Fires native HTML form submission straight to target script, bypassing any global JS intercepts
