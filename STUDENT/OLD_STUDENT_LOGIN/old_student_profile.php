            ...
            <div class="sidebar-wrapper" style="border-right: 1px solid rgba(255, 255, 255, 0.1)">
                <nav class="mt-2">
                    <div class="user-profile">
                        ...
                        <div class="user-info">
                            ...
                            <div class="status-text" style="color: #f1b813; font-size: 0.80rem; margin-top: -3px">BSIT -
                                3rd Year</div>
                            <div class="status-text" style="color: #4ade80; font-size: 0.75rem; margin-top: 2px">
                    ...
                    <ul class="nav sidebar-menu flex-column" id="navigation">
                        ...
                        <li class="nav-item">
                            <a href="old_student_profile.php" class="nav-link sidebar-bg-active">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div
                                    ...
                                    <i class="bi bi-telephone me-2 text-muted"></i>+63 912 345 6789
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div
                                    ...
                                    <i class="bi bi-envelope me-2 text-muted"></i>delacruzjuan@pcc.edu.ph
                                </div>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="card border-0 shadow-sm p-4 mb-4 bg-white" style="border-radius: 16px;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div
                                    class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary text-secondary font-monospace">
                                    <i class="bi bi-telephone me-2 text-muted"></i>+63 998 765 4321
                                </div>
                            </div>
                            <div class="col-12">
