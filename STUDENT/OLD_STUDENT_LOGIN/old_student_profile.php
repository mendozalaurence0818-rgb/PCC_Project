            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-1 text-muted small">
                                ...
                                <li class="breadcrumb-item active text-secondary" aria-current="page">Student Information</li>
                            </ol>
                        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card border-0 shadow-sm text-center p-4 h-100 bg-white" style="border-radius: 16px;">
                            <div class="position-relative d-inline-block mx-auto my-3">
                                ...
                                <span class="position-absolute bottom-0 end-0 bg-success border border-4 border-white rounded-circle p-2" title="Active Account"></span>
                            </div>

                            <h4 class="fw-bold mb-1" style="color: #002c5e;">Juan Dela Cruz</h4>
                            <p class="text-muted small mb-4 fw-medium" style="letter-spacing: 0.5px;">ID: 2024-001234</p>
                            ...
                            <div class="text-start px-2 mt-2">
                                ...
                                <div>
                                    ...
                                    <span class="text-break text-primary fw-medium" style="font-size: 0.95rem;">delacruzjuan@pcc.edu.ph</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary d-flex align-items-center justify-content-between">
                                        ...
                                        <small class="text-muted font-monospace" style="font-size: 11px;">1st Sem 2026-2027</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card border-0 shadow-sm p-4 mb-4 bg-white" style="border-radius: 16px;">
                            <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                                ...
                                <h5 class="fw-bold m-0 text-uppercase" style="color: #002c5e; font-size: 0.95rem; letter-spacing: 0.5px;">Contact Information</h5>
                            </div>
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label text-muted fw-semibold small mb-1">Student Full Name</label>
                                    <div class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary fw-medium text-secondary">Juan Dela Cruz</div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted fw-semibold small mb-1">Mobile Number</label>
                                    <div class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary text-secondary font-monospace"><i class="bi bi-telephone me-2 text-muted"></i>+63 912 345 6789</div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted fw-semibold small mb-1">Personal Email</label>
                                    <div class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary text-secondary"><i class="bi bi-envelope me-2 text-muted"></i>delacruzjuan@pcc.edu.ph</div>
                                </div>
                                <div class="col-12">
                                    <label class="form-label text-muted fw-semibold small mb-1">Permanent Residential Address</label>
                                    <div class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary text-secondary"><i class="bi bi-geo-alt me-2 text-muted"></i>123 Clear Ave, Manila, Philippines</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 shadow-sm p-4 mb-4 bg-white" style="border-radius: 16px;">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary fw-medium text-secondary">Jane Dela Cruz</div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted fw-semibold small mb-1">Contact Number</label>
                                    <div class="p-2.5 px-3 border border-light-subtle rounded-3 bg-body-tertiary text-secondary font-monospace"><i class="bi bi-telephone me-2 text-muted"></i>+63 998 765 4321</div>
                                </div>
                                <div class="col-12">
