...
<head>
    ...
    <style>
        ...
        /* Card Styles */
        .schedule-card { border: none; box-shadow: 0 0 25px rgba(0,0,0,0.06); border-radius: 12px; overflow: hidden; background-color: #fff; }
        ...
        .time-col { font-weight: 600; background-color: #f8f9fa; width: 130px; color: #495057; }
        ...
        .course-code { font-weight: 800; font-size: 0.9rem; display: block; margin-bottom: 2px; }
        .room-desc { font-weight: 500; font-size: 0.75rem; color: #495057; display: block; }
    </style>
</head>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                            <button class="btn btn-outline-pcc btn-sm fw-semibold rounded-pill px-3 me-2" onclick="window.print();">
                        ...
                        <div class="col-12">
                            <div class="card schedule-card">
                                <div class="card-header bg-white py-3 border-bottom d-flex align-items-center">
                                    <h5 class="card-title mb-0 fw-bold text-dark"><i class="bi bi-grid-3x3-gap-fill me-2 text-primary"></i>Visual Timetable</h5>
                                </div>
                                        ...
                                        <table class="table schedule-grid-table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="6" class="text-center text-muted fw-semibold bg-light" style="letter-spacing: 2px;">L U N C H &nbsp; B R E A K</td>
                                                </tr>
                                                <tr>
                        ...
                        <div class="col-12 mb-5">
                            <div class="card schedule-card">
                                <div class="card-header bg-white py-3 border-bottom">
                                    <h5 class="card-title mb-0 fw-bold text-dark"><i class="bi bi-card-list me-2 text-primary"></i>Enrolled Subjects List</h5>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tfoot class="bg-light border-top">
                                                <tr>
                                                    <td colspan="2" class="text-end fw-bold text-secondary">Total Enrolled Units:</td>
