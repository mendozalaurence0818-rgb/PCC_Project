                            ...
                            <div class="tab-pane fade show active" id="step1-builder" role="tabpanel">
                                <div class="row g-4">
                                    <div class="col-xl-4 col-lg-5">
                                        ...
                                        <div
                                            class="card enrollment-card mb-4 border-start border-4 border-warning bg-light-subtle">
                                            <div class="card-header bg-white py-3 border-bottom">
                                                <h6 class="card-title mb-0 fw-bold text-dark"><i
                                                        class="bi bi-shield-check me-2 text-warning"></i>Unit Counter &
                                                    Rules</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <div
                                                        class="d-flex justify-content-between small fw-bold text-secondary mb-1">
                                                ...
                                                <ul class="list-unstyled small mb-0 text-secondary">
                                                    <li class="mb-2 text-success"><i
                                                            class="bi bi-check-circle-fill me-2"></i>Prerequisite
                                                        Evaluation Resolved</li>
                                                    <li class="mb-2 text-success"><i
                                                            class="bi bi-check-circle-fill me-2"></i>Year Level
                                                        Constraint Cleared</li>
                                                    <li class="text-danger"><i
                                                            class="bi bi-exclamation-triangle-fill me-2"></i>Constraint
                                                        Alert: Total units under full-time limit.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-8 col-lg-7">
                                        <div class="card enrollment-card h-100">
                                            <div
                                                ...
                                                <h5 class="card-title mb-0 fw-bold text-dark"><i
                                                        class="bi bi-calendar-week me-2 text-secondary"></i>Real-Time
                                                    Visual Schedule Grid</h5>
                                                <span
                                                    class="badge bg-danger-subtle text-danger px-3 py-1 rounded-pill small fw-bold">Live
                                                    Conflict Matrix</span>
                                            </div>
                                            <div class="card-body p-3">
                                                    ...
                                                    <table class="table schedule-grid-table table-bordered mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td></td>
                                                                <td class="staged-slot">PE400<br><span
                                                                        class="fw-normal fs-8">Gym</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="time-col">09:00 - 10:30 AM</td>
                                                                <td class="staged-slot">IT411<br><span
                                                                        class="fw-normal fs-8">Lab 1</span></td>
                                                                <td></td>
                                                                <td class="staged-slot">IT411<br><span
                                                                        class="fw-normal fs-8">Lab 1</span></td>
                                                                <td></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="staged-slot">IT412<br><span
                                                                        class="fw-normal fs-8">Lec 304</span></td>
                                                                <td></td>
                                                                <td class="staged-slot">IT412<br><span
                                                                        class="fw-normal fs-8">Lec 304</span></td>
                                                                <td></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td class="text-muted bg-light fs-8">Staging Conflict
                                                                    Slot Window</td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
