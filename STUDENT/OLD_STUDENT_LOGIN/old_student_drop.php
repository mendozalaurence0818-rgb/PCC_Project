                                ...
                                <tbody class="text-secondary small">
                                    <tr class="border-bottom border-light-subtle">
                                        <td class="ps-0 py-3">
                                            ...
                                            <span class="text-muted font-monospace" style="font-size: 12px;">Information
                                                Assurance and
                                                Security</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="ps-0 py-3">
                                            ...
                                            <span class="text-muted font-monospace" style="font-size: 12px;">Readings in
                                                Philippine History</span>
                                        </td>
                                        <td class="py-3 fw-medium">3.0</td>
