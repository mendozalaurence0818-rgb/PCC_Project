                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="alert alert-primary d-flex align-items-center shadow-sm border-0" role="alert"
                                style="background-color: #e6f2ff; color: #002c5e;">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted fw-semibold">Batch 3 (3rd Year Students) - Schedule Builder
                                        unlocks at exactly 08:00 AM.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Your Midterm Grade for <span class="fw-bold text-dark">IT211 -
                                                            Integrative Programming</span> has been officially posted.
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pe-4 text-end text-muted small"><i
                                                            class="bi bi-clock me-1"></i> 3 hours ago</td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-4">
                                                        <span class="badge bg-danger-subtle text-danger tab-indicator">
                                                            <i class="bi bi-exclamation-circle-fill me-1"></i> Action
                                                            Required
                                                        </span>
                                                    </td>
                                                    <td>Please submit your <span class="fw-bold text-dark">Annual
                                                            Medical Clearance Form</span> to the campus clinic.</td>
                                                    <td class="pe-4 text-end text-muted small"><i
                                                            class="bi bi-clock me-1"></i> Yesterday</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div class="col-lg-4 col-12 mb-4">
                            <div class="card activity-card h-100">
                                ...
                                <div class="card-body">
                                    <p class="small text-muted mb-3">All units must be cleared before the Schedule
                                        Builder is unlocked for enrollment.</p>
                                    <ul class="list-group list-group-flush">
                                        <li
                                            ...
                                            <span class="badge bg-success rounded-pill px-3 py-2"><i
                                                    class="bi bi-check-circle-fill me-1"></i> Cleared</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        ...
                                        <li
                                            ...
                                            <span class="badge bg-danger rounded-pill px-3 py-2"><i
                                                    class="bi bi-x-circle-fill me-1"></i> Hold</span>
                                        </li>
                                    </ul>
                                </div>
